...
const LoadingPage = () => {
    return (
        <div className="flex items-center justify-center w-full h-[100vh]">
            <svg version="1.1" id="L1" xmlns="http://www.w3.org/2000/svg" xLink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" enableBackground="new 0 0 100 100" space="preserve">
