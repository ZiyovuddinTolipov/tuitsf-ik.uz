...
const Home = () => {
    ...
    return (
        ...
        <nav className={styles.content} data-aos="zoom-in-down">
            ...
            <h3 className={`text-2xl font-semibold font-Syne text-primary-500`}>EduRate</h3>
            <Link to='/login' className='text-2xl font-medium font-Syne flex items-center text-primary-500'>Login</Link>
        </nav>
        <div className='flex text-primary-500 font-Syne'>
            <div className='flex flex-col justify-center gap-8'>
                <h3 className='text-5xl  font-[700]'>Siz o’z <span>o’qituvchingizni baholash</span>ingiz mumkin!</h3>
                <div className='font-[600] home-alert-msg' data-aos="fade-right">
                    <p><span>Barcha ma'lumotlar </span>:<span> anonim saqlanadi</span></p>
        ...
        <footer className='absolute bottom-[10px] text-black font-Syne right-0'>Algorithmic.uz tomonidan ishlab chiqildi.</footer>
    </main>
    )
}
